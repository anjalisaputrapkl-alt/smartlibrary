...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const menuLinks = document.querySelectorAll('.nav-sidebar-menu a');
            
            menuLinks.forEach(link => {
                const href = link.getAttribute('href');
                if (href === currentPage || href === 'student-borrowing-history.php' && currentPage === 'student-borrowing-history.php') {
