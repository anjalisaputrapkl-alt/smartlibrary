...
try {
    ...
    try {
        ...
        error_log('get-maintenance-fines.php Error: ' . $e->getMessage());
    ...
    error_log('get-maintenance-fines.php Fatal Error: ' . $e->getMessage() . ' in ' . $e->getFile() . ':' . $e->getLine());
    http_response_code(500);
    echo json_encode([
        'success' => false,
