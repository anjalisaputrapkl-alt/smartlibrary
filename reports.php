...
$map = [];
foreach ($mem as $m) $map[$m['month']] = (int)$m['c'];
foreach ($period as $d) {
    $k = $d->format('Y-m');
    $mem_labels[] = $k;
    $mem_data[] = $map[$k] ?? 0;
...
foreach ($hourStmt->fetchAll() as $r) $hours[(int)$r['h']] = (int)$r['c'];
  ...
  <div class="card" style="margin-bottom:18px;">
    ...
    <div style="margin-top:12px;">
      ...
      <table id="tbl-borrows" class="datatable" style="width:100%;">
        <thead>
          <tr><th>ID</th><th>Tanggal</th><th>Buku</th><th>Anggota</th><th>Status</th><th>Due</th><th>Returned</th></tr>
        </thead>
        <tbody>
      ...
      <table id="tbl-returns" class="datatable" style="width:100%;">
        <thead>
          <tr><th>ID</th><th>Tanggal Pinjam</th><th>Tanggal Kembali</th><th>Keterlambatan (hari)</th><th>Buku</th><th>Anggota</th></tr>
        </thead>
        <tbody>
      ...
      <table id="tbl-books" class="datatable" style="width:100%;">
        <thead>
          <tr><th>ID</th><th>Judul</th><th>Penulis</th><th>Stok</th><th>Ditambahkan</th></tr>
        </thead>
        <tbody>
